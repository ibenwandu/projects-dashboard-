...
(salary, job type, date posted, location, title keywords). Uses Playwright.
"""
...
def build_search_urls(config: dict | None = None) -> list[str]:
    ...
    keywords = cfg.get("keywords") or ["Customer Experience", "Customer Success"]
    ...
    for q in keywords:
        for loc in locations:
            params = {"q": q, "l": loc, "fromage": days_posted}
