...
For 24/7 monitoring, you'll need to run the worker separately. The worker (`worker.py`) should be deployed separately (e.g., on Render) to check your watchlist every 15 minutes.
