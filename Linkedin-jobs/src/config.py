"""Configuration and constants. Job source is LinkedIn search."""
import os
import json
...
LINKEDIN_SEARCH_CONFIG_PATH = CONFIG_DIR / "linkedin_search.json"
...
def load_linkedin_search_config() -> dict:
    """Load LinkedIn search criteria from config/linkedin_search.json."""
    path = LINKEDIN_SEARCH_CONFIG_PATH
    if not path.exists():
        return {}
