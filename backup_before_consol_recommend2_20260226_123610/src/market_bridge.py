...
class MarketBridge:
    ...
    def _analyze_consensus_for_pair(
        ...
        base_llms = ['chatgpt', 'gemini', 'claude']
        sources = []
        base_llm_sources = []
        ...
        if not base_llm_sources and synthesis_text:
            ...
            if pair_clean_lower in text_lower:
                ...
                if 'all' in text_lower and ('agree' in text_lower or 'three' in text_lower or 'unanimous' in text_lower):
                    base_llm_sources = ['chatgpt', 'gemini', 'claude']
        ...
        # Calculate consensus level: count of base LLMs only (1, 2, or 3)
        ...
        # Ensure consensus_level is between 1 and 3
