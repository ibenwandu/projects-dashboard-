...
Same as **Glassdoor-jobs** but configured for **Customer Success / CX / Business Development** roles (keywords and scoring criteria). Use this project when searching for CS/CX/BD jobs on Glassdoor.
