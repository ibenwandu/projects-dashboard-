...
class ScalpEngine:
    ...
    def __init__(self):
        ...
        self._rl_db = None
        # RED FLAG duplicate-block log throttle: (pair, direction) -> last ERROR log time (consol-recommend2 Phase 1.2)
        self._red_flag_duplicate_last_logged = {}
        self._red_flag_duplicate_window_seconds = 600  # 10 min
