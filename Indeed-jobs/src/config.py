"""Configuration and constants. No Gmail; job source is Indeed search."""
import os
import json
...
INDEED_SEARCH_CONFIG_PATH = CONFIG_DIR / "indeed_search.json"
# Resume PDF template (same as job-alert-resume)
...
def load_indeed_search_config() -> dict:
    """Load Indeed search criteria from config/indeed_search.json."""
    path = INDEED_SEARCH_CONFIG_PATH
    if not path.exists():
        return {}
